...
class Bank_account:
    def __init__(self, account_name, account_number, account_type, name, gender, phone_number, password, ifsc_code, balance):
    ...
    def account_details_tuples(self):
        return (self.account_name, self.account_number, self.account_type, self.name, self.gender, self.phone_number, self.password, self.ifsc_code, self.balance)
    ...
    def create_account(accounts):
        ...
        new_account = Bank_account(account_name, account_number, account_type, name, gender, phone_number, password, ifsc_code, initial_balance)
    ...
    def edit_account(accounts):
        ...
        for account in accounts:
            if account.account_number == account_number and account.password == password:
                ...
                print("8. Change IFSC code")
                print("9. Change balance")
